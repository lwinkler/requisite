...
def check_all_rules(entry: en.Entry) -> Sequence[EntryErrorMessage]:
...
) -> Sequence[EntryErrorMessage]:
    """Check rule spec-entry-attributes-non-null"""

    messages: Sequence[EntryErrorMessage] = []
...
def check_definition_id_mandatory(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_statement_id_mandatory(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_id_unique(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_id_valid(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_id_spec(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_id_req(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_links(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_child_statements(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_child_definition(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_child_test_list(entry_to_check: en.Entry) -> Sequence[EntryErrorMessage]:
...
def check_test_verify_id_mandatory(design: en.Entry) -> Sequence[EntryErrorMessage]:
