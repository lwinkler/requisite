...
def arguments_parser():
	...
	# Main parser
	parser = argparse.ArgumentParser(description='Generate reports for a stock portfolio')

	parser.add_argument("--debug", action = "store_true", dest = "debug", default = False, help = "Run the application with faulthandler to debug crashes and segmentation faults. Installed with 'pip3 install faulthandler' ")
